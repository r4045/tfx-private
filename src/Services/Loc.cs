...
internal static class Loc
{
    ...
    private static readonly Dictionary<string, string> Japanese = new()
    {
        ...
        ["Pinned tab: {0}"] = "タブをピン留めしました: {0}",
        ["Unpinned tab: {0}"] = "タブのピン留めを解除しました: {0}",
        ["Pinned tab — unpin to close (F6)"] = "ピン留めタブ — 閉じるには F6 で解除",
        ["New Tab"] = "新しいタブ",
        ...
        ["Copied name: {0}"] = "名前をコピーしました: {0}",
        ["Copied {0} name(s)"] = "{0} 個の名前をコピーしました",
        ["Failed to copy name: {0}"] = "名前のコピーに失敗しました: {0}",
